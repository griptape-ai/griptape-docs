...
Prompt drivers are used by Griptape structures to make calls to the underlying LLMs. `OpenAiChatPromptDriver` is the default prompt driver used in all structures.
